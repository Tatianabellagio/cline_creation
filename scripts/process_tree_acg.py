...
#outputs
vcf_files = snakemake.output["vcf_files"]
population_counts_files = snakemake.output["population_counts_files"]
#genetic_diversity_files = snakemake.output["genetic_diversity_files"]
...
for vcf_file, population_counts_file, gens_ago in zip(vcf_files, population_counts_files, [3,2,1,0]):
    ...
    with open(vcf_file, 'w') as file:
        ...
        nts.write_vcf(output=file, individuals = alive_individuals, allow_position_zero = True)
